...
class TimeContentsCDFSComponent(BaseContentsTableComponent):
    ...
    Attributes:
        ...
        proxy_type: The proxy type for time contentsfile.
    """
    # Attributes #
    ...
    async def correct_contents_async(
        ...
        """Asynchronously corrects the contentsfile of the file.
    ...
    def create_contents_proxy(self, swmr: bool = True, **kwargs) -> TimeContentsProxy:
        """Creates a contentsfile proxy for the CDFS component.
        ...
        Returns:
            TimeContentsProxy: The created contentsfile proxy.
        """
